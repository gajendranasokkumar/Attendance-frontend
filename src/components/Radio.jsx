    ...
    return (
        <>
            <div className='relative h-[45px] flex justify-center mb-8'>
                <p className='absolute left-6 top-[-15px] bg-white px-2 text-inputBorder font-semibold rounded-2xl'>{placeholder}</p>
                <div className='input w-[100%] h-[50px] flex items-center justify-end'>
                    <label className="control control-radio ml-40 w-[50%]">
                    ...
                    <label className="control control-radio ml-8 w-[50%]">
